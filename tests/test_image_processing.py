...
@pytest.mark.parametrize("dtype, rtol", [("float32", 1e-15), ("float64", 1e-15)])
def test_historgram_equalization_tile_interpolation_ref_impl(dtype, rtol):
    ...
    npt.assert_allclose(res_ti, ref, rtol=rtol)
